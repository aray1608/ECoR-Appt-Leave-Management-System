...
import { FaBriefcase, FaCalendarAlt, FaMapMarkerAlt, FaUser } from 'react-icons/fa';
...
const LeaveForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('http://localhost:5001/api/leaves/add', {
        method: 'POST',
        headers: {
    ...
    <div className="appointment-form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="button-group" style={{ display: 'flex', gap: '10px', marginTop: '20px' }}>
          ...
          <button type="button" onClick={handleReturnHome} className="secondary-btn">
            Return to Homepage
          </button>
        </div>
      </form>
